...
library(apaTables)
apa.reg.table(H1.A3m, filename = "Table2_H1_H3.doc", table.number = 2)
...
apa.reg.table(cppm1, filename = "Table4_CPP.doc", table.number = 3)
...
(figure %<>% fill_panel(tr_prop_adj_gplot))
(figure %<>% fill_panel(tr_prop_adv_gplot))
